...
>
    ...
    <div class="row">
        <div class="col-12">
            @include('inventory.purchase-returns.create')
            @include('inventory.purchase-returns.view')
            <div class="card">
                <div class="card-header">
                    <h3>Devoluciones a Proveedor
                ...
                <div class="card-body">
                    <livewire:inventory.purchase-returns-table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        Livewire.on('store', () => {
            ...
            Swal.fire({ icon: 'success', title: 'Devolución registrada correctamente', showConfirmButton: false, timer: 1500 });
        });
