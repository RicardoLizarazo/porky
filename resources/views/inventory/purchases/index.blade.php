...
>
    ...
    <div class="row">
        <div class="col-12">
            ...
            @include('inventory.purchases.edit')
            <div class="card">
                ...
                <div class="card-body">
                    <livewire:inventory.purchases-table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        Livewire.on('store', () => {
            ...
            Swal.fire({ icon: 'success', title: 'Compra guardada en borrador', showConfirmButton: false, timer: 1500 });
        });
        ...
        Livewire.on('update', () => {
            ...
            Swal.fire({ icon: 'success', title: 'Compra actualizada correctamente', showConfirmButton: false, timer: 1500 });
        });

        Livewire.on('confirmPurchase', ({ id }) => {
            Swal.fire({
                title: '¿Confirmar esta compra?',
                text: 'El inventario y el costo promedio se actualizarán y la compra no se podrá modificar.',
                icon: 'question',
        ...
        Livewire.on('confirmed', () => {
            $('#modal-edit').modal('hide');
            Swal.fire({ icon: 'success', title: 'Compra confirmada', text: 'El inventario fue actualizado.', showConfirmButton: false, timer: 2000 });
        });
